...
data class UserSettings(
    ...
    fun toSystemPromptString(): String {
        ...
        return buildString {
            ...
            appendLine("- Если в контексте есть конкретная информация о проекте - используй её")
            appendLine("- Не придумывай то, чего нет в контексте")
            appendLine("- Указывай, из какого документа взята информация, если это уместно")
            append("================================\n")
        }
    }
